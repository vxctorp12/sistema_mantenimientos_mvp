    ...
    <AuthenticatedLayout>
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <div class="flex gap-3">
                    <Link :href="route('equipos.index')" 
                          class="px-4 py-2 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-200 text-sm rounded-lg font-medium hover:bg-gray-300 dark:hover:bg-gray-600 transition">
        ...
        <div class="py-6 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 p-4 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <select v-model="impreso" class="w-full border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg text-sm focus:ring-blue-500">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm overflow-hidden border border-gray-100 dark:border-gray-700">
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-gray-700 text-sm text-gray-700 dark:text-gray-300">
                        <tr v-for="item in mantenimientos.data" :key="item.id" class="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                            ...
                            <td class="p-4">
                                ...
                                <div class="text-xs text-gray-400 dark:text-gray-500">{{ item.equipo?.codigo_inventario || 'Sin Inv.' }}</div>
                            </td>
                            <td class="p-4">
                            ...
                            <td class="p-4">
                                ...
                                <div class="text-xs text-gray-400 dark:text-gray-500">{{ item.equipo?.departamento_unidad || 'N/A' }}</div>
                            </td>
                            <td class="p-4 text-xs font-medium text-gray-600 dark:text-gray-300">
                                {{ item.tecnico?.name || item.tecnico?.nombre || 'Técnico' }}
                            </td>
                            <td class="p-4 text-center">
                                <span v-if="item.impreso" class="px-3 py-1 text-xs font-bold rounded-full bg-green-100 dark:bg-green-900/40 text-green-700 dark:text-green-300">
                                    ✓ Impreso
                                </span>
                            ...
                            <td class="p-4 text-right">
                                ...
                                <span v-else class="text-xs text-gray-400 dark:text-gray-500">Solo lectura</span>
                            </td>
                        </tr>
